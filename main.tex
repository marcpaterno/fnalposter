...
\title{Some Random Topic} % Poster title
\author{Marc Paterno} % Author(s)

\institute{Fermi National Accelerator Laboratory} % Institution(s)
...
\begin{center}
\begin{tabular}{ccc}
\includegraphics[width=0.4\linewidth]{FNAL-Logo-White} & \
  \hfill & \
  \includegraphics[width=0.4\linewidth]{FNAL-Logo-Blue}
\end{tabular}
\end{center}
